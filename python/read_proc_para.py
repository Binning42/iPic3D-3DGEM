...
last_cycle=1001
step=100
directory = "../data/" #Directory of the simulation data
...
shape=(33,33,2) # Shape of one field array for 1 proc*.hdf file. TEMPORARY. Need to read the shape of each proc domain.
####################################################################################
